...
export function head() {
  return {
    title: "Spectral chords — Polymath",
    description:
  ...
  return (
    <article>
      <PageHeader
        ...
        tier="real"
        lede="The app's signature feature: take an element's real emission lines and drop them ~40 octaves into the audible range. The reduction is exact arithmetic; the lines are genuine physics. Here are hydrogen's Balmer lines."
      />
      ...
      <p class={styles.note}>
        ...
        hydrogen's spectrum to sound. The claim that this reveals a deeper "harmonic" truth about the element
        is interpretation — but the sound itself is honest arithmetic.
      </p>
    </article>
  );
}
