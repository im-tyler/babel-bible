// Pythagorean triples — the real, standard mathematics under Grant's "force
// triangles." Pure functions, no DOM, unit-tested. Tier: STANDARD.
...
/**
 * Grant's "special" consecutive-leg family (hypotenuse = long leg + 1):
...
/**
 * The factor pair Grant leans on for the consecutive-leg family:
