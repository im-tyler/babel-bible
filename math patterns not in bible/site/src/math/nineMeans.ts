// The nine classical means of a triangle (a, b, c). All nine are
// closed-form expressions; the genuine, verified fact is that three of them
// form nested similar right triangles.
...
/**
 * Compute all nine means for a triple (a = short leg, b = long leg, c = hypotenuse).
 */
