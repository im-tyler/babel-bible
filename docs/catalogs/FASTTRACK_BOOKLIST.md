# Fast Track Curriculum — Master Booklist
...
- **FREE** — author or publisher hosts PDF freely / legal open access
- **PD** — likely public domain (pre-1928 or old Soviet with expired rights)
- **BUY** — under active copyright; acquire via library, purchase, or institutional access
- **?** — needs verification
...
|---|-------|--------|-------|--------|
| 0.1 | Basic Mathematics | Serge Lang | Pre-calc foundations | BUY |
| 0.2 | Calculus, Vol 1 (Single Variable) | Tom M. Apostol | Single-variable calculus, proof-based | BUY |
| 0.3 | Calculus, Vol 2 (Multi-Variable) | Tom M. Apostol | Multivariable calculus, linear algebra intro | BUY |
| 0.4 | Ordinary Differential Equations | Vladimir Arnold | ODEs via geometric/qualitative perspective | BUY |
...
| # | Title | Author | Topic | Status |
|---|-------|--------|-------|--------|
| 1.01 | Linear Algebra | Georgiy Shilov | Linear algebra fundamentals, proof-based | PD? (Dover reprint of Soviet text) |
...
| 1.10 | Lectures on Differential Geometry | Shlomo Sternberg | Diff geom, multilinear algebra, Lie groups | ? (older, may have free versions) |
| 1.11 | Dynamical Systems IV (Symplectic Geometry) | Arnol'd, Dubrovin | Symplectic geometry | BUY |
| 1.12 | Topological Methods in Hydrodynamics | Vladimir Arnol'd | Diff geom in fluid mechanics | BUY |
...
| 1.17 | Differential Forms in Algebraic Topology | Bott, Tu | Cohomology, differential forms, De Rham | BUY |
...
| 1.20 | Finite Element Exterior Calculus | Douglas N. Arnold | Numerical PDEs via FE | ? (some author notes may be free) |
...
| 2.02 | Quantum Theory, Groups and Representations | Peter Woit | QM via rep theory, geometric quantization | **FREE** (author hosts draft PDF) |
| 2.03 | QFT Lecture Notes | Sourav Chatterjee | Second quantization, basic QFT | **FREE** (Stanford) |
...
| 2.15 | MIT OCW: Statistical Mechanics II | MIT (Kardar et al) | Stat field theory course | **FREE** (MIT OCW) |
| 2.16 | Stochastic Quantization | Parisi et al | Stochastic quantization | ? |
...
| 3.03 | Morse Theory | John Milnor | Critical points, Bott periodicity | BUY (some archives free) |
| 3.04 | Morse Homology | Matthias Schwarz | Homology via Morse functions | BUY |
| 3.05 | Lectures on Field Theory and Topology | Daniel Freed | TQFT, cobordism | ? (AMS may have partial) |
| 3.06 | Floer Homology Groups in Yang-Mills Theory | S.K. Donaldson | Infinite-dim Morse, gauge theory | BUY |
...
| 3.16 | Probability and Representation Theory | Persi Diaconis | Probability via rep theory | ? (author may host notes) |
...
| 3.21 | Algebraic Geometry | Robin Hartshorne | Varieties, schemes, sheaves | BUY |
...
| 3.27 | Hodge Theory and Complex Algebraic Geometry | Claire Voisin | Hodge theory via complex geometry | BUY |
...
| 3.35 | Spin Geometry | Lawson, Michelsohn | Clifford algebras, spinors, index theorem | BUY |
...
| 3.38 | A Concise Course in Algebraic Topology | J. Peter May | Algebraic topology survey | **FREE** (author PDF) |
| 3.39 | More Concise Algebraic Topology | May, Ponto | Localization, completion, model categories | **FREE** (author PDF) |
| 3.40 | Simplicial Objects in Algebraic Topology | J. Peter May | Simplicial methods | **FREE** (author PDF) |
| 3.41 | Simplicial Homotopy Theory | Goerss, Jardine | Homotopy via simplicial objects | BUY |
| 3.42 | Complex Cobordism and Stable Homotopy Groups of Spheres | Doug Ravenel | Cobordism, stable homotopy | **FREE** (Green Book, author PDF) |
| 3.43 | Quantum Fields and Strings Vols. 1-2 | Deligne, Kazhdan, Etingof, Morgan, Freed, Morrison, Jeffrey, Witten | Mathematical QFT, gauge theory, strings | ? (IAS hosted some lectures free) |
...
- Nima Arkani-Hamed — "Decoherence in Quantum Mechanics" lecture (YouTube)
- Discrete Morse theory references (various)
- Persistent homology materials (various)
- Combinatorial algebraic topology resources (various)

---

## Summary

- **Total primary texts:** ~72
- **Confirmed FREE:** ~8 (Brown, Woit, Chatterjee, MIT OCW, May ×3, Ravenel)
- **Likely PD or free archive:** ~2–4 (Shilov, older Milnor)
- **Needs verification:** ~5
- **BUY required:** ~55+

## Next Steps

1. Verify sourcing status on all `?` entries
2. Build dependency graph (which texts prerequisite which)
3. Select Phase 1 subset (prereqs + first ~10 texts of Section 1) for pilot
4. Draft content-creation scaffold: per-text outline → concept map → lesson units → Lean exercises
