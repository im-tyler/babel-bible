...
|---|---|---|---|
| Backward-reference density (per 1000w) | 9.05 | 8.0 | ✓ |
| Forward-promise density (per 1000w) | 1.70 | 3.0 | ✗ |
| Lateral connections (per Master section) | 4.60 | 3 | ✓ |
| Synthesis claims (Intermediate) | 3.00 | 2 | ✓ |
| Synthesis claims (Master) | 3.94 | 4 | ✗ |
| Anchor-phrase reuse rate | 1.00 | 0.95 | ✓ |

## Failures

- forward_density: 1.70 < 3.0
- synthesis_master: 3.94 < 4
