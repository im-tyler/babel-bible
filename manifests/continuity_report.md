...
|---|---|---|---|
| Backward-reference density (per 1000w) | 9.36 | 8.0 | ✓ |
| Forward-promise density (per 1000w) | 1.93 | 3.0 | ✗ |
| Lateral connections (per Master section) | 4.98 | 3 | ✓ |
