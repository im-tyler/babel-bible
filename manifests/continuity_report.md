...
|---|---|---|---|
| Backward-reference density (per 1000w) | 15.29 | 8.0 | ✓ |
| Forward-promise density (per 1000w) | 3.62 | 3.0 | ✓ |
| Lateral connections (per Master section) | 4.92 | 3 | ✓ |
| Synthesis claims (Intermediate) | 2.62 | 2 | ✓ |
| Synthesis claims (Master) | 4.70 | 4 | ✓ |
...
| 03.04.E1 | content/03-modern-geometry/04-differential-forms/03.04.E1-mv-degree-exercises.md | 1.40 |
| 03.12.E1 | content/03-modern-geometry/12-homotopy/03.12.E1-rational-homotopy-exercises.md | 2.18 |
...
| 06.06.05 | content/06-riemann-surfaces/06-jacobians/06.06.05-theta-function.md | 4.21 |
