...
- **03.12.33**: Kan-Quillen model structure on sSet. Reason: homotopy model-category cluster flagged §18.2 skip; Goerss-Jardine rigor required.
- **03.12.35**: Simplicial model category and the function complex. Reason: homotopy model-category cluster flagged §18.2 skip.
- **03.12.37**: Homotopy colimit (Bousfield-Kan construction). Reason: advanced homotopy; Bousfield-Kan construction is frontier.
- **03.12.38**: Bousfield-Kan spectral sequence. Reason: advanced homotopy; spectral-sequence arguments.
- **03.12.40**: Postnikov tower of a Kan complex. Reason: advanced homotopy; Postnikov-classification arguments.
- **03.12.45**: Arithmetic square and integral fracture theorems. Reason: advanced homotopy; fracture-theorem proofs.
