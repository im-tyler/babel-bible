...
- **Logic [49.01.01].** Statistical fallacies are instances of logical fallacies: affirming the consequent (finding data consistent with a hypothesis does not prove the hypothesis), false dichotomy (statistical significance vs no effect), and hasty generalisation (drawing conclusions from small or biased samples).
