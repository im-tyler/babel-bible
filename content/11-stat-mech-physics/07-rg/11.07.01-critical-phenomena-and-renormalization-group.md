...
Linearise the φ⁴ $\beta$ function about $u_*$ by writing $u = u_* + \delta u$ and keeping the leading term:
...
The Wilson-Fisher fixed point has slope $\beta'(u_*) = \epsilon > 0$ in the φ⁴ direction, meaning the φ⁴ coupling is **irrelevant** at the fixed point itself: small perturbations $\delta u$ shrink under further coarse-graining. The flow approaches $u_*$ along a one-dimensional stable manifold in the $(r, u)$ plane; this is the **critical surface**. Above this surface lies the ordered (broken-symmetry) phase; below lies the disordered phase; transverse to it lies the relevant temperature direction. The slope $+\epsilon$ in the φ⁴ direction is a self-consistency check: for $\epsilon = 0$ the eigenvalue vanishes, recovering the marginal behaviour at the upper critical dimension.
...
At one loop the anomalous dimension of the field vanishes: $\eta_{1\text{-loop}} = 0$. The lowest non-vanishing contribution comes from two loops via the "sunset" diagram for the φ self-energy. The result, from Wilson-Kogut 1974 and Brezin-Le Guillou-Zinn-Justin 1976, is
