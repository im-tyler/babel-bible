...
![Diagram showing a river flowing from top to bottom around several rocks of different sizes. The water path curves smoothly around obstacles without sharp angles. Labels read: 'Wu wei — the water does not force its way; it finds the natural path.' Below the river, text reads: 'The Dao is like water — it benefits all things and does not compete with them. It stays in places that others disdain, therefore it is close to the Dao.' (Daodejing, Ch. 8)](/img/20.10.04-river-wuwei-placeholder.svg)
