...
R.A. Fisher's fundamental theorem of natural selection (1930) states that the rate of increase in mean fitness of a population at any time is equal to the genetic variance in fitness at that time. Formally, if $\bar{w}$ is the mean fitness and $V_g$ is the additive genetic variance in fitness:
...
(a) Recessive phenotype frequency: $q^2 = 160/1000 = 0.16$. So $q = \sqrt{0.16} = 0.4$.

(b) $p = 1 - q = 1 - 0.4 = 0.6$.

(c) Heterozygous carriers: $2pq = 2(0.6)(0.4) = 0.48$. Number: $0.48 \times 1000 = 480$.
