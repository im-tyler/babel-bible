...
Before Newton, celestial and terrestrial physics were treated as separate domains. Newton showed that a single mathematical law — universal gravitation — governs both falling apples and orbiting planets. This established the principle of universal physical law.
...
Kepler's second law implies that the product of distance and velocity (the areal velocity) is constant: $r_p \cdot v_p = r_a \cdot v_a$.

$v_a = v_p \cdot r_p / r_a = 30.3 \times 147.1 / 152.1 = 30.3 \times 0.967 = 29.3$ km/s
...
(a) The evidence: Newton developed his "method of fluxions" in 1665-1666 but shared it only in manuscript form with a small circle of correspondents. Leibniz developed his differential and integral calculus independently in 1675 and published his first paper in 1684, nine years before Newton published his method. Both arrived at equivalent results through different notations and different conceptual approaches (Newton thought in terms of rates of change over time; Leibniz thought in terms of infinitesimal differences and sums). The independent discovery of equivalent methods supports Robert Merton's thesis that scientific discoveries are typically "multiple" — the intellectual preconditions make the discovery likely to occur.

(b) Institutional power: Newton, as President of the Royal Society from 1703, used his institutional authority to control the investigation of the priority dispute. He appointed the committee that investigated the matter (which included his supporters), drafted the committee's report (which favored himself), and had it published anonymously. The Royal Society's report accused Leibniz of plagiarism, a charge that was almost certainly false. The episode demonstrates that scientific institutions are not immune to the exercise of personal power and that the ideal of disinterested, objective evaluation can be compromised when the evaluator has a personal stake in the outcome.

(c) Implications for credit: The dispute illustrates the inadequacy of the "first to discover" model of scientific credit. Newton was first to develop the method but failed to communicate it effectively. Leibniz was first to publish and developed a superior notation that is still used today (the integral sign, d notation for differentials). The modern practice of establishing priority through publication (rather than private correspondence) was partly a response to this kind of dispute. The case also raises the question of whether credit should go to the first discoverer, the first publisher, or the person whose version proves most useful to the community.
