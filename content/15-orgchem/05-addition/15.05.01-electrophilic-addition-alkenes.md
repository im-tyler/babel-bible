...
- **Mutation and repair [17.06.01].** The C5-C6 double bond in thymine is an electron-rich alkene susceptible to photochemical [2+2] cycloaddition, producing cyclobutane pyrimidine dimers — the same pericyclic reaction type described in this unit. The mutation and repair unit treats UV-induced CPD formation as the canonical example of exogenous DNA damage and the substrate for nucleotide excision repair.
