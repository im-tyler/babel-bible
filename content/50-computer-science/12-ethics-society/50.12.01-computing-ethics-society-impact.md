...
prerequisites: [50.09.01, 50.10.01, 50.11.01]
tier_anchors:
...
![Diagram showing the feedback loop of algorithmic bias: Historical data reflecting societal biases is used to train algorithms, which then make biased decisions, which generate new biased data, which is fed back into the training process. Breaking this cycle requires deliberate intervention at multiple points.](/img/50.12.01-algorithmic-bias-loop-placeholder.svg)
