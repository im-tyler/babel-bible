...
prerequisites: [50.04.01, 50.02.01, 50.03.01]
tier_anchors:
...
![Diagram of the test pyramid showing a broad base of unit tests, a middle layer of integration tests, and a narrow top of end-to-end tests. Arrows indicate increasing scope and cost from bottom to top.](/img/50.10.01-test-pyramid-placeholder.svg)
