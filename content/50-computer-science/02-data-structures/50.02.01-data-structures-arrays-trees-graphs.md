...
![Diagram of a binary search tree with root 15, left subtree containing 8, 5, 12, and right subtree containing 20, 18, 25. Arrows illustrate the search path for the value 12: start at 15 (go left because 12 < 15), arrive at 8 (go right because 12 > 8), arrive at 12 (found).](/img/50.02.01-bst-search-placeholder.svg)

![Comparison of graph representations for a 4-vertex undirected graph. Left: adjacency list showing each vertex followed by its neighbors. Right: adjacency matrix showing a 4x4 grid with 1s indicating edges and 0s indicating no edge.](/img/50.02.01-graph-representations-placeholder.svg)
