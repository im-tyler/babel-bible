...
prerequisites: [25.02.01, 25.04.01]
tier_anchors:
...
![Entity-relationship diagram for a university database. Three entities: Students (student_id, name, major), Courses (course_id, title, credits), and Enrollments (student_id, course_id, grade). Lines connect Students to Enrollments (one-to-many) and Courses to Enrollments (one-to-many).](/img/25.07.01-er-diagram-placeholder.svg)
