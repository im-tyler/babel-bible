...
prerequisites: [25.06.01, 25.07.01, 25.08.01]
tier_anchors:
...
![Diagram of Raft consensus: 5 nodes arranged in a row. One is labeled Leader with an arrow pointing down to a log entry. The other 4 are labeled Followers. Arrows show the leader replicating log entries to followers. A majority (3 of 5) must acknowledge before the entry is committed.](/img/25.11.01-raft-consensus-placeholder.svg)
