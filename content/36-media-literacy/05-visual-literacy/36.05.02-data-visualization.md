...
**Graphical integrity principles (Tufte).** Show data variation, not design variation; label clearly and in detail; reveal data at several levels of detail; keep the visual measure consistent with the quantity (area for area, length for length).
