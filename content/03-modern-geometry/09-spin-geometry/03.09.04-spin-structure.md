...
**Bridge.** The construction here builds toward [03.09.05] (spinor bundle), where the same data is upgraded, and the symmetry side is taken up in [03.09.08] (dirac operator). The defining pattern appears again in those units in a sharpened form, where the local data is glued or quotiented. Putting these together, the foundational insight is that the data of this unit gives the structural signature that the rest of the strand reads off.
