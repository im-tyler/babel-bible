...
**Bridge.** The construction here builds toward [03.06.04] (pontryagin and chern classes), where the same data is upgraded, and the symmetry side is taken up in [03.07.05] (yang-mills action). The defining pattern appears again in those units in a sharpened form, where the local data is glued or quotiented. Putting these together, the foundational insight is that the data of this unit gives the structural signature that the rest of the strand reads off.
