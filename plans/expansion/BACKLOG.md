...
- [x] **Psychology (29)** — `plans/expansion/social-sciences/` — 27 new units (all 11 chapters). Sources: Myers 2021, Kandel 2021. 12 → 39 units. All 27/27 validated.
...
- [x] **History of Science (33)** — same plan file — 8 new units (all 8 chapters). Sources: Cohen, Bowler-Morus. 8 → 16 units. All 27/27 validated.
  - [x] PRODUCE: 8 chapters (8 units) → integrated → committed
  - [x] COMPLETENESS: converged

- [x] **Music & Art (34)** — same plan file — 8 new units (priority chapters). Sources: Meyer, Gombrich, Arnheim. 8 → 16 units. All 27/27 validated.
