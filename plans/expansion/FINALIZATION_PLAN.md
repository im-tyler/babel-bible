...
- **2026-06-30 — Phase 2 waves 32-33 (batch mode; 8 units; deploy still blocked).** Wave 32: `35.10.02` Cardiopulmonary bypass / heart-lung machine (health-medicine/surgery-emergency) — Gibbon 1931-1953 (May 6 1953 first open-heart on Cecilia Bavolek, ASD repair) → Bigelow 1950 hypothermia → Lillehei-DeWall 1955 bubble oxygenator → Kirklin 1955 Mayo. `35.10.03` Organ transplantation (health-medicine/surgery-emergency) — Carrel 1902 → Medawar 1944 → Murray Dec 23 1954 first kidney transplant (1990 Nobel) → Borel 1972 cyclosporine → Barnard 1967 heart → Maryland 2022 pig-heart xenograft. Calcineurin-NFAT-IL-2 immunosuppression defended. `34.09.03` Greek tragedy and comedy (music-art/theater-drama) — Thespis ~534 BCE → Aeschylus Oresteia 458 → Sophocles Oedipus Rex ~429 → Euripides Medea 431 → Aristophanes Lysistrata 411 → Aristotle Poetics ~335. `29.13.04` Intelligence testing history (psychology/psychometrics) — Binet-Simon 1905 → Yerkes Army Alpha/Beta 1917-21 → Spearman 1904 g → Wechsler 1939 → Flynn 1984 Psych. Bull. effect (~3 pts/decade) → Herrnstein-Murray 1994 Bell Curve. Wave 33: `29.15.02` Personnel selection (psychology/I-O) — Schmidt-Hunter 1998 Psych. Bull. 124:262 (GMA r~0.51, best single predictor across all jobs). `29.12.02` Cross-cultural cognition (psychology/cross-cultural) — Markus-Kitayama 1991 → Nisbett 2001 Science (holistic vs analytic) → Masuda-Nisbett 2001 eye-tracking → Henrich 2010 Nature WEIRD critique. `20.12.03` Speech act theory (philosophy/phil-of-language) — Austin 1962 locutionary/illocutionary/perlocutionary → Searle 1969 taxonomy → Grice 1967 Cooperative Principle + maxims. `18.13.03` Chemosensation (organismal-bio/sensory-systems) — Ikeda 1908 umami → Buck-Axel 1991 Cell 65:175 olfactory receptor family (2004 Nobel) → combinatorial coding → COVID-19 anosmia. All eight 27/27 first-pass. **Switched to batch mode** (per Tyler): no per-wave site rebuild; single build at end. Deploy still blocked (deploy-ovh 100.83.22.26 unreachable since wave 30). Corpus 2,624 → **2,632**; validate_all 70,850 → **70,958**.

- **2026-06-30 — Phase 2 wave 31 (4-unit HIGH-LEVERAGE wave; deploy still blocked).** `29.02.05` The neuroscience of sleep (psychology/neuroscience) — Aserinsky-Kleitman 1953 Science 118:273 (REM discovery) → Jouvet 1959 (PGO spikes) → Moruzzi-Magoun 1949 (ARAS) → Borbély 1982 Hum. Neurobiol. 1:195 (2-process model) → Sakurai 1998 Cell 92:573 (orexin/hypocretin) → Lin 1999 Cell 98:365 (narcolepsy link) → Saper-Scammell-McCarley 2005 Neuron 47:775 (wake-sleep flip-flop) → Tononi-Cirelli 2003-2014 (synaptic homeostasis) → Nedergaard 2013 Science 341:610 (glymphatic system, 60% more active during sleep, clears β-amyloid). Flip-flop bistability via nullcline analysis; sleep-onset timing derived from 2-process model. `34.10.03` Petipa and the Imperial Russian ballet (music-art/dance) — Louis XIV Académie 1661 → Noverre 1760 (ballet d'action) → Romantic ballet 1830s-40s (Taglioni La Sylphide 1832, Perrot Giselle 1841) → Marius Petipa 1847-1910 at the Maryinsky → Tchaikovsky collaborations (Sleeping Beauty 1890, Nutcracker 1892, Swan Lake 1895) → Diaghilev Ballets Russes 1909 → Balanchine neo-classical. Sleeping Beauty Rose Adagio worked example (Princess Aurora in attitude turning between four suitors). `20.11.03` Personal identity: Parfit, fission, teleportation, and the reductionist view of the self (philosophy/metaphysics) — Locke 1694 Essay 2.27 (memory criterion) → Butler 1736 (circularity objection) → Reid 1785 (gallant officer / transitivity failure) → Hume 1739 (bundle theory) → Shoemaker 1963 (psychological continuity) → Williams 1970 ("Self and the Future" torture experiment) → Lewis 1976 (counterpart theory) → Nagel 1971 (brain bisection) → Parfit 1984 "Reasons and Persons" (canonical reductionism: personal identity = relation R; identity is not what matters) → Olson 1997 (animalism) → Schechtman 1996/2014 (narrative). The fission thought experiment worked example. `35.09.04` Magnetic resonance imaging physics (health-medicine/medical-diagnostics-imaging) — Bloch 1946 Phys. Rev. 70:460 (the Bloch equations dM/dt = γM×B − M_⊥/T2 − (M_z−M_0)/T1) → Purcell-Torrey-Pound 1946 (1952 Nobel) → Lauterbur 1973 Nature 242:190 (first MR image via gradients; 2003 Nobel) → Mansfield 1977 J. Phys. C 10:L55 (echo-planar imaging EPI, single-shot; basis of fMRI) → Edelstein-Hutchison 1980 (spin-warp, clinical standard) → Le Bihan 1986 (diffusion MRI) → Ogawa 1990 PNAS (BOLD contrast, deoxyhemoglobin paramagnetic) → Kwong 1992 PNAS (first human fMRI). Bloch equations derived from Zeeman Hamiltonian; k-space FT identity; Stejskal-Tanner diffusion weighting in Full proof set. All four 27/27 first-pass. Personal-identity producer corrected Williams 1970 (the famous "Self and the Future" torture experiment is Williams 1970, not 1956-57 as in dispatch). MRI producer flagged the validator/UNIT_SPEC mismatch: the playbook lists "key mechanism" as a health-medicine evidence keyword, but the validator code doesn't implement it and falls back to math keywords. **Deploy still blocked** — deploy-ovh (100.83.22.26) unreachable since wave 30 (Tailscale / network issue on Tyler's side). Site v`93a6a96f` (wave 29) remains the live version. Corpus 2,620 → **2,624**; validate_all 70,634 → **70,742**; lenses clean.

- **2026-06-30 — Phase 2 wave 30 (4-unit HIGH-LEVERAGE wave; deploy blocked).** `16.02.04` Molecular symmetry and point groups (inorgchem/symmetry-group-theory) — Bravais 1850 → Fedorov-Schönflies 1890s (space groups) → Schoenflies 1891 "Krystallsysteme" → Burnside 1897 "Theory of Groups of Finite Order" → Wigner 1930s (1963 Nobel) → Mulliken 1933 J. Chem. Phys. (Mulliken symbols; 1966 Nobel) → Wilson-Decius-Cross 1955 "Molecular Vibrations" → Cotton 1971. The great orthogonality of characters derived; CH₄ T_d 9-mode → 2-IR-band reduction as the worked example. `28.03.04` Galaxy formation and evolution (astronomy/galaxies) — Hubble 1926 (sequence) → Toomre-Toomre 1972 ApJ 178:623 (Antennae merger simulation) → White-Rees 1978 MNRAS 183:341 (ΛCDM framework) → Blumenthal-Fabers-Primack-Rees 1984 → Kauffmann-White-Guiderdoni 1993 → Madau 1998 MNRAS 298:L36 (cosmic star-formation history, peak z~2) → Baldry-Glazebrook 2004 (color bimodality) → Springel 2005 (Millennium) → Schaye 2015 (EAGLE) → Madau-Dickinson 2014 ARAA 53:415 → Springel 2018 (IllustrisTNG). Madau-plot peak location derived. `18.10.04` Vaccines and immunological memory (organismal-bio/immunology) — Jenner 1796 smallpox → Pasteur 1885 rabies → Burnet 1957 clonal selection (1960 Nobel) → Tonegawa 1976 V-D-J recombination (1987 Nobel) → Doherty-Zinkernagel 1974 MHC restriction (1996 Nobel) → MacLennan 1994 (germinal center) → Karikó-Weissman 2005 Immunity modified-nucleoside mRNA (2023 Nobel). Pfizer/Moderna COVID-19 2020 mRNA vaccines worked example (~95% efficacy, 14M+ lives saved). SIR-derived herd-immunity threshold $p_c = 1 - 1/R_0$. `27.10.03` Soil carbon cycling and the rhizosphere microbiome (earth-science/soil-science-pedology) — Dokuchaev 1883 → Jenny 1941 (CLORPT factors) → Waksman 1927 → Parton et al. 1987 Geoderma (CENTURY soil-carbon model) → Lehmann 2006 Nature (biochar) → Tarnocai 2009 (permafrost carbon ~1330-1580 Gt C) → Smith 2007 (climate-smart soils) → Melillo 2002/2011 (Harvard Forest warming) → "4 per 1000" COP21 Paris 2015 initiative. CENTURY framework defended; passive-pool dominance (~88% of steady-state SOC) and warming-feedback scaling $C^*(T_0+\Delta T) = C^*(T_0) Q_{10}^{-\Delta T/10}$ derived. All four 27/27 first-pass. Galaxy-evolution producer noted an Antennae distance discrepancy (24 Mpc Hubble flow vs ~60 Mly worked-example figure) and flagged it honestly with the peculiar-velocity caveat. **Deploy blocked**: the deploy-ovh server (100.83.22.26) was unreachable during the wave-30 deploy attempt (Tailscale / network issue on Tyler's side; out of orchestrator scope). Site v`93a6a96f` (wave 29) remains the live version. Corpus 2,616 → **2,620**; validate_all 70,526 → **70,634**; lenses clean.

- **2026-06-30 — Phase 2 wave 29 (4-unit HIGH-LEVERAGE wave).** `35.05.04` Ketamine and the glutamatergic revolution in depression (health-medicine/mental-health) — Schildkraut 1965 (monoamine hypothesis) → Berman 2000 Biol. Psychiatry 48:751 (first controlled ketamine trial) → Zarate 2006 Arch. Gen. Psychiatry 63:856 (onset within 2 hr, sustained ~1 week) → Duman 2012+ (BDNF/mTOR synaptogenesis) → FDA 2019 esketamine approval → Williams 2018/2019 opioid-component controversy. The glutamate-AMPA-BDNF-mTOR cascade defended. `27.08.04` The Permian-Triassic mass extinction (earth-science/earth-history) — Newell 1967 → Raup-Sepkoski 1982 Science 215:1501 (Big Five) → Renne-Basu 1991 Science (Siberian Traps ~251 Ma dating) → Wignall 2001-2007 (anoxia/euxinia) → Reichow 2009 (~4M km³ lava volume) → Burgess-Bowring-Shen 2014 PNAS (synchronous timing) → Song 2013 PNAS (two-pulse structure). Carbon-isotope mass balance derived. `20.14.03` The capabilities approach (philosophy/political-philosophy) — Sen 1979 Tanner Lecture "Equality of What?" → Sen 1985 "Commodities and Capabilities" → Sen 1999 "Development as Freedom" → Nussbaum 2000 "Women and Human Development" (10 central capabilities) → Nussbaum 2011 "Creating Capabilities". UNDP HDI as policy application. `29.11.04` Self-determination theory (psychology/motivation-emotion) — Maslow 1943 hierarchy of needs → Deci 1971 (Soma puzzle overjustification) → Lepper-Greene-Nisbett 1973 (nursery drawing) → Deci-Ryan 1985 SDT (autonomy, competence, relatedness) → Ryan-Deci 2000 Am. Psychol. 55:68 (modern synthesis) → Niemiec-Ryan 2009 (education), Gagné-Deci 2005 (work), Przybylski-Rigby-Ryan 2010 (video games). All four 27/27 first-pass. Capabilities producer corrected one citation to canonical venue (Nussbaum 1988 Oxford Studies in Ancient Philosophy Supp. Vol.). Corpus 2,612 → **2,616**; validate_all 70,418 → **70,526**; lenses clean; site rebuilt (2,687 pages, 0 skipped) + deployed (version `93a6a96f`, retired wave 28's `263ce240`).

- **2026-06-30 — Phase 2 wave 28 (4-unit HIGH-LEVERAGE wave).** `16.04.05` Alfred Werner and the foundation of coordination chemistry (inorgchem/coordination) — Jørgensen's chain theory → Werner 1893 Z. Anorg. Chem. 3:267 (age 26; primary vs secondary valence) → Werner-Miolati 1895-96 conductivity studies → Werner 1911 [Co(en)₃]³⁺ resolution (first inorganic chirality) → 1913 Nobel. The cis/trans isomerism of [Co(NH₃)₄Cl₂]Cl as the canonical worked example. `27.05.04` The biological pump (earth-science/oceanography) — Redfield 1934 (C:N:P = 106:16:1) → Sverdrup 1953 critical depth → Eppley-Peterson 1979 f-ratio → Azam 1983 microbial loop → Allredge-Silver 1988 marine snow → Martin-Fitzwater-Gordon 1987 Nature 331:341 (Martin curve F(z) = F₀ × (z/100)^-b, b ≈ 0.86) → Martin 1990 Nature 345:156 iron hypothesis → SOFeX 2012 → Henson 2011-12 transfer efficiency. IRONEX/SOFeX iron-fertilization worked example. `29.10.04` Psychodynamic psychotherapy (psychology/therapy-treatment) — Breuer-Freud 1895 (Anna O. case) → Freud 1900 Dream Interpretation → Anna Freud 1936 ego defenses → Klein 1930s-50s positions → Winnicott transitional objects → Mahler separation-individuation → Fairbairn → Kohut 1971 self psychology → Kernberg TFP for BPD → Davanloo ISTDP → Shedler 2010 Am. Psychol. 65:98 efficacy meta-analysis. `28.05.04` Exoplanet atmospheres (astronomy/exoplanets) — Charbonneau 2002 ApJ 568:377 (Na on HD 209458b) → Deming-Seager 2005 secondary eclipse → Kasting-Whitmire-Reynolds 1993 Icarus 101:108 (habitable-zone moist/maximum-greenhouse limits) → Kreidberg 2014 Nature HAT-P-11b water → JWST ERS 2022 WASP-39b CO₂ (first unambiguous) and SO₂ → K2-18b DMS controversy. Lambert-approximation transit-depth formula derived. All four 27/27 first-pass. Corpus 2,608 → **2,612**; validate_all 70,310 → **70,418**; lenses clean; site rebuilt (2,683 pages, 0 skipped) + deployed (version `263ce240`, retired wave 27's `4cfae2c8`).

- **2026-06-30 — Phase 2 wave 27 (4-unit HIGH-LEVERAGE wave).** `29.08.04` The person-situation debate (psychology/personality) — Allport 1937 trait theory → Hartshorne-May 1928 honesty studies → Mischel 1968 "Personality and Assessment" (personality coefficient ~0.30 challenge) → Epstein 1979 aggregation principle → Mischel-Shoda 1995 Psychological Review (CAPS / if-then behavioral signatures) → Fleeson 2001 density-distributions → Funder 2006 → Roberts 2007 (maturation meta-analysis). `18.11.04` Induced pluripotent stem cells (organismal-bio/development) — Stevens 1950s-70s (teratocarcinomas) → Evans-Kaufman 1981 (mouse ESCs) → Gurdon 1962 (frog nuclear transfer, 2012 Nobel) → Thomson 1998 Science (hESCs) → Takahashi-Yamanaka 2006 Cell 126:663 (the OSKM = Oct4/Sox2/Klf4/c-Myc reprogramming) → Yamanaka 2007 Cell 131:861 (human) → Mandai 2014 NEJM (autologous iPSC retinal transplant) → 2024 first autologous iPSC solid-organ (liver) transplant. `16.01.04` Mendeleev's periodic table of 1869 (inorgchem/periodic-trends) — Döbereiner 1817 (triads) → Newlands 1865 (octaves) → Meyer 1864-1870 → Mendeleev 1869 J. Russ. Chem. Soc. 1:60 → 1871 extended table → eka-element predictions confirmed (gallium Lecoq 1875; scandium Nilson 1879; germanium Winkler 1886 — predicted atomic weight 72 density 5.5, observed 72.6 / 5.35, the canonical confirmation) → Moseley 1913 atomic-number reordering → Seaborg 1944 actinides → modern table to element 118. `28.06.04` The Apollo program (astronomy/space-exploration) — Tsiolkovsky 1903 → Goddard 1926 → Sputnik 1957 → Gagarin 1961 → Kennedy 1961/1962 speeches → Apollo 1 1967 fire → Apollo 7-10 testing → Apollo 11 July 20 1969 (Armstrong-Aldrin-Collins; 1202 alarms, ~25 sec fuel remaining; 21.5 kg samples) → Apollo 13 1970 oxygen-tank explosion → Apollo 17 Dec 1972 last landing. 12 Moonwalkers; 382 kg lunar samples; Saturn V (~110 m, 35 MN thrust). Artemis 2022+ return-to-Moon. All four 27/27 first-pass. One producer honestly flagged the dispatch's imprecise Roberts 2007 reference (the 2007 Psych. Bull. paper is on predictive validity; the maturation meta-analysis is the 2008 Handbook chapter) and cited both with correct bibliographic details. Another conservatively stated the 2024 iPSC liver transplant claim. Corpus 2,604 → **2,608**; validate_all 70,202 → **70,310**; lenses clean; site rebuilt (2,679 pages, 0 skipped) + deployed (version `4cfae2c8`, retired wave 26's `e0f3aecc`).

- **2026-06-30 — Phase 2 wave 26 (4-unit HIGH-LEVERAGE wave).** `18.09.04` The menstrual cycle: HPO axis, follicular and luteal phases, and Knobil's discovery of pulsatile GnRH (organismal-bio/reproductive) — Knauer 1900 → Harris 1947 (hypothalamic control of anterior pituitary) → Knobil 1970s rhesus-monkey pulsatile-GnRH experiments (continuous GnRH paradoxically suppresses; basis for leuprolide) → Hotchkis-Knobil 1974 hormonal profiles → Leyendecker-Wildt 1980s GnRH-pulse therapy → Beitins 1981 PCOS. Biphasic estradiol feedback derived. Combined hormonal contraception worked example. `34.06.03` The Bauhaus (music-art/architecture-design) — Gropius 1919 manifesto → Werkbund-Muthesius 1907 precursor → Itten-Moholy-Nagy-Josef Albers Vorkurs lineage → three directors (Gropius, Meyer, Mies) → three locations (Weimar 1919-1925, Dessau 1925-1932, Berlin 1932-1933) → 1933 Nazi closure → diaspora to Harvard GSD (Gropius), IIT (Mies), New Bauhaus Chicago (Moholy-Nagy), Black Mountain (Alberses). Dessau building 1925-1926 worked example (UNESCO World Heritage 1996). `16.06.04` Iron-sulfur clusters (inorgchem/bioinorganic) — Mortenson 1962 ferredoxin → Beinert 1960s-1980s EPR characterization → Beinert-Holm-McKinney 1997 biogenesis → Sazanov-Hinchliffe 2006 complex I structure → Wächtershäuser 1988 iron-sulfur world → Russell-Hall 1997 hydrothermal vents → Martin-Russell 2003 LUCA. Mitochondrial complex I (8-9 Fe-S clusters, ~100 Å electron tunneling) worked example. `20.09.04` Gödel's incompleteness theorems (philosophy/phil-of-math) — Hilbert 1900 problem 2 → Principia 1910-1913 → Gödel 1931 Monatshefte Math. 38:173 first and second incompleteness theorems → Gentzen 1936 ε₀ partial rescue → Turing 1936 Halting Problem → Cohen 1963 forcing and CH independence → Lucas 1961 / Penrose 1989 AI-mind argument. Continuum Hypothesis worked example. All four 27/27 first-pass. Two producers caught citation errors in the dispatch brief and used historically accurate venues (Sazanov 2006 for complex I, not Iwata 1996 which was complex IV; Lucas 1961 Philosophy 36:112, not the brief's "Lucas 1959 Mind"). One producer resolved an alt-text regex issue by stripping square brackets from image alt text. Corpus 2,600 → **2,604**; validate_all 70,094 → **70,202**; lenses clean; site rebuilt (2,675 pages, 0 skipped) + deployed (version `e0f3aecc`, retired wave 25's `5b792796`).

- **2026-06-30 — Phase 2 wave 25 (4-unit HIGH-LEVERAGE wave; corpus passes 70,000 checks).** `20.08.04` Kuhn, Lakatos, and Laudan (philosophy/phil-of-science) — Hanson 1958 (theory-ladenness) → Kuhn 1962 Structure → Lakatos 1970 research programmes (hard core + protective belt; progressive vs degenerating) → Feyerabend 1975 (Against Method) → Laudan 1977 (research traditions; reticulated model). The Copernican revolution as canonical case (~150 years Copernicus 1543 → Newton 1687). Incommensurability-does-not-entail-relativism argument defended. `29.07.05` Interpersonal attraction and close relationships (psychology/social-psychology) — Berscheid-Walster 1969 → Festinger-Schachter-Back 1950 (proximity) → Hazan-Shaver 1987 (adult attachment) → Sternberg 1986 triarchic (intimacy/passion/commitment) → Rusbult 1980 investment model → Reis-Shaver 1988 → Aron-Aron 1986 self-expansion → Gottman-Levenson 1992 ("four horsemen" — criticism, contempt, defensiveness, stonewalling; 5:1 ratio). Harvard Study of Adult Development: relationship quality at 50 predicts late-life health more than cholesterol. `35.06.04` The US opioid epidemic (health-medicine/public-health) — Portenoy 1986 (misleading reassurance) + Porter-Jick 1980 NEJM (5-sentence letter misused as evidence) → Purdue 1996 OxyContin launch → three waves of overdose deaths (Rx opioids → heroin → illicit fentanyl, 1999-2021, ~645,000 total) → CDC 2016 prescribing guideline → SAMHSA 2023 buprenorphine deregulation → Purdue bankruptcy 2019 / Sackler ~$6 billion settlement 2022. Supply-restriction paradox derived. Case-Deaton "deaths of despair." `28.04.05` Large-scale structure formation (astronomy/cosmology) — Jeans 1902 → Lifshitz 1946 (cosmological perturbation theory) → Peebles 1965-80 → Press-Schechter 1974 ApJ 187:425 (halo mass function: $f(>M) = \mathrm{erfc}(\delta_c/\sqrt{2}\sigma(M))$) → Bond-Myers-Szalay 1991 (excursion-set / cloud-in-cloud fix) → BBKS 1986 transfer functions → NFW 1997 (universal halo profile) → Sheth-Tormen 1999 (ellipsoidal refinement) → Springel 2005 Millennium → Eisenstein 2005 BAO → IllustrisTNG 2018. CMB anisotropies (COBE 1992 → WMAP 2003 → Planck 2013) as the seed-fluctuation evidence. All four 27/27 first-pass. Corpus 2,596 → **2,600** (milestone: passed 2,600 units); validate_all 69,986 → **70,094** (milestone: passed 70,000 checks); lenses clean; site rebuilt (2,671 pages, 0 skipped) + deployed (version `5b792796`, retired wave 24's `663c80d3`).

- **2026-06-30 — Phase 2 wave 24 (4-unit HIGH-LEVERAGE wave).** `16.05.04` Ferrocene and the sandwich compounds (inorgchem/organometallic) — Kealy-Pauson 1951 accidental synthesis → Wilkinson-Woodward / Fischer 1952 sandwich-structure inference → 18-electron rule → Togni-Spindler 1994 Josiphos → Blaser-Spindler-Studer 2001 (S)-metolachlor process. `34.01.04` Rhythm, meter, and cross-cultural time (music-art/music-fundamentals) — Cooper-Meyer 1960 → Lerdahl-Jackendoff 1983 GTTM → Chernoff 1979 / Arom 1991 African polyrhythm → Agawu 1995 critique → London 2004 attentional-entrainment → Toussaint 2013 geometry of rhythm. Steve Reich "Clapping Music" (1972) as the worked example. `20.05.05` Evo-devo: deep homology and the genetic tool-kit (philosophy/phil-of-biology) — Haeckel 1866 (rejected) vs von Baer 1828 → Lewis 1978 Hox bithorax → Nusslein-Volhard-Wieschaus 1980 → McGinnis 1984 homeobox → King-Wilson 1975 regulatory hypothesis → Gehring 1994 Pax6 (mouse Pax6 in fly leg → fly eye) → Carroll 2005 deep-homology thesis → Pigliucci-Müller 2010 extended synthesis. `29.06.05` Adolescent brain development (psychology/development) — Huttenlocher 1979 synaptic pruning → Giedd 1999 longitudinal pediatric MRI → Sowell 1999-2004 → Galvan 2006 ventral-striatal activation → Somerville-Jones-Casey 2010 PFC-limbic asymmetry → Steinberg-Casey 2008 dual-systems model → Roper v. Simmons 2005, Graham v. Florida 2010, Miller v. Alabama 2012 (neuroscience reshaping juvenile justice). All four 27/27 first-pass. Two producers noted brief / validator domain keyword mismatches and used validator-compatible headings (Key result for chemistry; Key theorem for music-art). Corpus 2,592 → **2,596**; validate_all 69,878 → **69,986**; lenses clean; site rebuilt (2,667 pages, 0 skipped) + deployed (version `663c80d3`, retired wave 23's `a3d56201`).
