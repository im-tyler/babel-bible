...
- **Globally hyperbolic Lorentzian manifolds; Cauchy surface; Bernal-Sánchez splitting** (audit item 4, Priority 1) — `13.09.01-globally-hyperbolic-lorentzian-manifolds`. Also independently covered at `03.02.17-lorentzian-hopf-rinow-and-global-hyperbolicity`.
