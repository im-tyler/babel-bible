...
- **prereqs (verified to exist):** `03.04.04` (exterior derivative), `03.06.06` (Chern-Weil homomorphism), `03.05.16` (holonomy / Lie-group action context) or `07.06.09` (Borel-Weil) for the group-action prerequisite, `05.04.05` (Duistermaat-Heckman — the prototype example to point back to).
...
| Weitzenböck / Bochner-Weitzenböck identity | `03.09.14`, `03.09.16`, `03.02.15` (Bochner technique) | shipped |
